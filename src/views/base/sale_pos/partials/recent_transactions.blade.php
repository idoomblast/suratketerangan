		...
		@foreach ($transactions as $transaction)
			<tr class="cursor-pointer" 
				...
				<td>
                    ...
                    <a href="{{action('SellPosController@printInvoice', [$transaction->id])}}" class="print-invoice-link" style="padding-right: 20px">
                        <i class="fa fa-print text-muted" aria-hidden="true" title="{{__('lang_v1.click_to_print')}}"></i>
                    </a>

	    			<a href="{{action('\Idoomblast\SuratKeterangan\Controller\SuratKeteranganController@printSuratKeterangan', [$transaction->id])}}" class="print-invoice-link">
	    				<i class="fa fa-print text-muted" aria-hidden="true" title="Click To Print Surat Keterangan"></i>
	    			</a>
				</td>
			</tr>
		@endforeach
